...
public class ContactServiceTest {
	...
	void testUpdateFirstName() {
		...
		service.addContact("Mr.", "Apples", "5555551111", "123 Applepie Blvd");
		service.updateFirstName("Travis", "9");
		service.displayContactList();
		assertEquals("Travis", service.getContact("9").getFirstName(), "First name was not updated.");
	}
